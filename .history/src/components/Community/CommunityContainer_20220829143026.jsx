...
import { follow, unFollow, toggleFollowing, getUsers, getUsersOnPage } from '../../redux/community-reducer';
...
export default connect(mapStateToProps,
    { follow, unFollow, toggleFollowing, getUsers, getUsersOnPage })(CommunityContainer)
