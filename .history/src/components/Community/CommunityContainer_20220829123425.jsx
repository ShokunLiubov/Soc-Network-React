...
import { follow, setUsers, unFollow, setPage, setUsersTotalCount, toggleFetching, toggleFollowing, getUsersThunkCreator, getUsersOnPage } from '../../redux/community-reducer';
...
export default connect(mapStateToProps,
    { follow, unFollow, setUsers, setPage, setUsersTotalCount, toggleFetching, toggleFollowing, getUsersThunkCreator, getUsersOnPage })(CommunityContainer)
